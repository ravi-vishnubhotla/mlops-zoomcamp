...
def run_train(data_artifact: str):
    ...
    rf = RandomForestRegressor(max_depth=config.max_depth, random_state=0, n_estimators=config.n_estimators, min_samples_split=config.min_samples_split, min_samples_leaf=config.min_samples_leaf)
